...
function makeValueKey(node) {
    ...
    const sortedAttrs = Object.keys(node.attrs)
        .sort()
        .reduce((acc, k) => { acc[k] = node.attrs[k]; return acc; }, {});
...
class CSEPass {
    ...
    run(graph) {
        ...
        for (const nodeId of order) {
            ...
            const consumers = (0, graphUtils_1.buildConsumerMap)(workGraph);
...
exports.CSEPass = CSEPass;
//# sourceMappingURL=csePass.js.map