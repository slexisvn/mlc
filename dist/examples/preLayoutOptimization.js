...
exports.runPreLayoutOptimizationExample = runPreLayoutOptimizationExample;
const graph_1 = require("../ir/graph");
const constantFoldingPass_1 = require("../passes/constantFoldingPass");
const csePass_1 = require("../passes/csePass");
const deadCodeEliminationPass_1 = require("../passes/deadCodeEliminationPass");
const passManager_1 = require("../passes/passManager");
const validate_1 = require("../ir/validate");
// ─── Helper: pretty-print PassLog entries ─────────────────────────────────────
function printLogs(passName, logs) {
...
function addConstantScalar(g, name, value) {
...
function runExampleA() {
    ...
    (0, constantFoldingPass_1.resetCFCounter)();
    const g = new graph_1.Graph("cf_dce_example");
    ...
    // ── Apply passes ──────────────────────────────────────────────────────────
    const cfPass = new constantFoldingPass_1.ConstantFoldingPass();
    const dcePass = new deadCodeEliminationPass_1.DeadCodeEliminationPass();
    ...
    const valid = (0, validate_1.validateGraph)(finalGraph);
...
function runExampleB() {
    ...
    // ── Apply passes ──────────────────────────────────────────────────────────
    const csePass = new csePass_1.CSEPass();
    const dcePass = new deadCodeEliminationPass_1.DeadCodeEliminationPass();
...
function runExampleC() {
    ...
    (0, graph_1.resetCounters)();
    (0, constantFoldingPass_1.resetCFCounter)();
    const g = new graph_1.Graph("full_simplification");
    // Runtime input.
    ...
    const pm = new passManager_1.PassManager({
    ...
    pm.addPasses(new constantFoldingPass_1.ConstantFoldingPass(), new csePass_1.CSEPass(), new deadCodeEliminationPass_1.DeadCodeEliminationPass());
...
// Entry point
// ─────────────────────────────────────────────────────────────────────────────
function runPreLayoutOptimizationExample() {
    console.log("\n╔══════════════════════════════════════════════════════════╗");
...
//# sourceMappingURL=preLayoutOptimization.js.map