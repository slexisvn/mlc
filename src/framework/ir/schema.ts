...
export interface ParameterData {
  ...
  /**
   * When true the data is fully known at compile time.
   * The bridge will attach a `constantPayload` so ConstantFoldingPass can
   * evaluate downstream ops without runtime values.
   */
