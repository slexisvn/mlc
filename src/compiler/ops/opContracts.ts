...
export const DEFAULT_OP_CONTRACTS: readonly OpContract[] = [
  ...
  { op: "pool2d",   fusibilityClass: "fusible",     layoutBehavior: "sensitive",    pure: true,  foldable: false, requiredInputLayouts: [Layouts.NCHW], description: "2-D pooling (requires NCHW input)" },
